...
void setup(){                                               //
     ...
     watch.begin(&Wire); // &Wire1, &Wire2 ...              // Инициируем работу с часами, указав ссылку на объект для работы с шиной I2C на которой находится часы.
}                                                           // Объект основной аппаратной шины I2C (Wire) можно не указывать: watch.begin();
                                                            //
void loop(){                                                //
